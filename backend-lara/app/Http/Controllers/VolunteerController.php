...
class VolunteerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            Mail::to(env('MAIL_RECEIVER_ADDRESS'))->send(new VolunteerMail($details));
            $volunteer_request_detail = VolunteerRequest::create($details);
        } catch (Exception $e) {
            return response()->json([
                'status' => false,
        ...
        return response()->json([
            ...
            'volunteer' => $volunteer_request_detail
        ], 201);
    }
